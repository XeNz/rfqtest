...
import { Avatar, Badge, Container, IconButton, Popover, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverTrigger, ScaleFade, SkeletonText, Stack, Table, Tbody, Td, Th, Thead, Tr, useToast } from '@chakra-ui/react';
                    ...
                    <Popover>
                        ...
                        <PopoverContent>
                            ...
                            <PopoverBody textAlign={'center'}>
                                ...
                                <Stack align={'center'} justify={'center'} direction={'column'} mt={3}>
                                    <Badge
                                        px={2}
                                        py={1}
                                        fontWeight={'400'}>
